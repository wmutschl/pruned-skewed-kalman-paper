...
%arch = 'maci64';
%arch = 'win64';
DisplayResults_MakeLatexTables_ExpectedLosses(['results_state_estimation_DGP1_T40_R2400_'  arch]);
DisplayResults_MakeLatexTables_ExpectedLosses(['results_state_estimation_DGP1_T80_R2400_'  arch]);
DisplayResults_MakeLatexTables_ExpectedLosses(['results_state_estimation_DGP1_T110_R2400_' arch]);

DisplayResults_MakeLatexTables_ExpectedLosses(['results_state_estimation_DGP2_T40_R2400_'  arch]);
DisplayResults_MakeLatexTables_ExpectedLosses(['results_state_estimation_DGP2_T80_R2400_'  arch]);
DisplayResults_MakeLatexTables_ExpectedLosses(['results_state_estimation_DGP2_T110_R2400_' arch]);
