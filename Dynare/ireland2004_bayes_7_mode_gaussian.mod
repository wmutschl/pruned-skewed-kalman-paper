...
estimation(datafile = '../data/ireland2004_data.m'
          ...
          , mh_replic = 0
          , mode_compute = 8
          , mode_file = '../results/ireland2004/bayes/ireland2004_gaussian_slice_short_mh_mode.mat'
          , plot_priors = 0
...
copyfile([M_.dname '/Output/' M_.fname '_mode.mat'], ['../results/ireland2004/bayes/ireland2004_gaussian_mode8.mat']);

estimation(datafile = '../data/ireland2004_data.m'
          , lik_init = 1
          , mh_replic = 0
          , mode_compute = 6
          , mode_file = '../results/ireland2004/bayes/ireland2004_gaussian_mode8.mat'
          , plot_priors = 0
          , kalman_algo = 5  % use pruned skewed Kalman filter routine even in Gaussian case for comparability;
                             % note that Dynare's implementation is much faster because it switches to the steady-state Kalman filter which we have not implemented yet for the PSKF
          );
copyfile([M_.dname '/Output/' M_.fname '_mode.mat'], ['../results/ireland2004/bayes/ireland2004_gaussian_mode6.mat']);
copyfile([M_.dname '/Output/' M_.fname '_optimal_mh_scale_parameter.mat'], ['../results/ireland2004/bayes/ireland2004_gaussian_optimal_mh_scale_parameter.mat']);
