...
REDO = 0; % 0: load mat file with results, 1: redo estimation with initial values provided in estim_params file, 2: redo estimation with search for initial values
