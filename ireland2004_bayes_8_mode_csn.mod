...
% RWMH SAMPLER IS INITIALIZED AT MODE AND COVARIANCE MATRIX FROM OPTIMIZATION                    %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
estimated_params;
...
estimation(datafile = 'data/ireland2004_data.m'
          ...
          , mh_replic = 0
          , mode_compute = 8
          , mode_file = 'ireland2004_bayes_4_mode_slice_csn/Output/ireland2004_bayes_4_mode_slice_csn_mh_mode.mat'
          , plot_priors = 0
          );
copyfile('ireland2004_bayes_8_mode_csn/Output/ireland2004_bayes_8_mode_csn_mode.mat','ireland2004_bayes_8_mode_csn/Output/ireland2004_bayes_8_mode_csn_mode8.mat');
...
estimation(datafile = 'data/ireland2004_data.m'
          ...
          , mh_replic = 0
          , mode_compute = 6
          , mode_file = 'ireland2004_bayes_8_mode_csn/Output/ireland2004_bayes_8_mode_csn_mode8.mat'
          , plot_priors = 0
          );
copyfile('ireland2004_bayes_8_mode_csn/Output/ireland2004_bayes_8_mode_csn_mode.mat','ireland2004_bayes_8_mode_csn/Output/ireland2004_bayes_8_mode_csn_mode6.mat');
